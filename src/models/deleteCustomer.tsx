  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.delete(
        `${API}/delete/stkItem/${customerToDelete.cid}/${customerToDelete.name.replace("I-", "")}`,
        {
        ...
        <div className="flex items-center justify-between">
          <div className="flex gap-2 items-center">
            ...
            <h2 className="text-xl font-semibold text-gray-800">
              {t("hd_stkDelete")} {/* Assuming this translates to "Delete Customer" or similar */}
            </h2>
          </div>
          {loading && (
        ...
        {customerToDelete ? (
          <div className="text-gray-700 text-sm space-y-1">
            ...
            <ul className="text-sm list-inside pl-2 text-gray-600 mt-4 space-y-1 list-none">
              <li>
                <strong>{t("lbl_groupLbl")}:</strong> {customerToDelete.cid}
              </li>
              <li>
                <strong>{t("lbl_relateSubItemId")}:</strong>{" "}
