  ...
  return (
    <section className="overflow-hidden h-full rounded-lg bg-white sm:w-[calc(100vw-224px)] w-[calc(100vw-25px)]">
      ...
      <button
        ...
        className={`absolute bottom-10 right-10 bg-blue-100 text-blue-600 hover:bg-blue-200 px-4 py-2.5 flex justify-center items-center rounded-xl border-[0.5px] border-blue-600 ease-in-out duration-300 text-md font-semibold z-50 hover:scale-105 cursor-pointer flex-row shadow-sm hover:shadow-md`}
      >
        {t("btnTxt_newCus")}
      </button>
    </section>
