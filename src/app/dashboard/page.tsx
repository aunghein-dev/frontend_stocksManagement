  ...
  if(!business?.businessId && !isBusinessInfoLoading) {
    return (
      <div className='flex justify-center items-center p-4'>
        <p className="text-red-600 text-sm font-medium text-center p-6 rounded-lg bg-gray-50 shadow-xs">
      ...
      <div className="bg-white rounded-lg py-2 shadow-xs">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:[grid-template-columns:60%_40%] gap-2 pt-4 md:pt-6 pb-4 md:pb-6 border-b border-gray-200 w-full pr-2">
            <div className="flex items-center min-h-[250px] md:min-h-[300px] justify-center bg-gray-50 rounded-sm p-2 pt-10 border-[0.5px] border-gray-100 shadow-xs relative">
            ...
            <div className="flex items-center justify-center min-h-[250px] md:min-h-[300px]
                            p-2 rounded-sm bg-gray-50 pt-10 border-[0.5px] border-gray-100 shadow-xs relative">
              {dashboardData.radar!==null ? (
                <div className='w-full'>
                     <Radar
          ...
          <div className="grid grid-cols-1 lg:[grid-template-columns:60%_40%] gap-2 px-3 lg:pr-4 pt-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
              <div className="min-h-[200px] flex justify-center items-center bg-gray-50 
                              rounded-sm border-[0.5px] border-gray-100 shadow-xs relative">
