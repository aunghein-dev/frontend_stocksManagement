      ...
      >
        ...
        <div className="grid grid-cols-2 gap-8 mb-8 text-[0.82rem] px-6 mt-8">
          ...
          <div>
            ...
            <p className="font-medium text-gray-900">Openware Solutions</p>
            <p className="text-gray-700">{invoice.tranProvider} - 09799103451</p>
        ...
        <div className="flex justify-center">
          <p className="text-[0.80rem] text-gray-500 mb-4 px-2">Thank you for your business!</p>
        </div>
      </div>
    </div>
  );
