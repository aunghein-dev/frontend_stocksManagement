...
export function SignupForm() {
  ...
  <button
        ...
        className="w-full bg-blue-600 text-white font-semibold rounded-lg py-3 hover:bg-blue-700 focus:outline-none focus:ring-[1.5px] focus:ring-blue-600 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
      >
