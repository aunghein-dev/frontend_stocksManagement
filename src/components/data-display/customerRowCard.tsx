 ...
 const typeCustomerStyle = (typeOfCustomer: string) => {
  ...
  return (
    <div className="flex h-[100px] w-full bg-white border border-gray-200 rounded-sm overflow-hidden
              ...
              <div className="flex flex-row items-center justify-start text-left">
                 <Image src={props.imgUrl}
                  ...
                  <div className="flex flex-col gap-1 ml-2">
                    <span
                      className="text-[0.875rem] font-semibold max-w-[200px] cursor-pointer"
              ...
              <span className="text-xs h-[60px] w-[60px] flex flex-col items-center justify-center
                             bg-red-50 rounded-full text-red-700 font-semibold
                              border-[0.5px] border-red-100">{props.customerDueAmt}</span>
              <span className={`text-[0.7rem] ml-3 px-2 py-1 rounded-2xl border-[0.5px]
