...
function PaginationButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={`
        h-8 w-8 rounded-full mx-0.5
        focus:outline-none focus:ring-[1.5px] focus:ring-blue-600
        transition
        ${isActive ? "bg-blue-600 text-white cursor-default" : "bg-gray-100 text-gray-700 hover:bg-gray-300"}
...
export default function PaginationComponent({
  ...
  return (
    <nav className="flex justify-center overflow-x-auto px-[0px] py-1 bg-white rounded-sm shadow-md">
