...
const flattenBatchCustomerReport = (customers: CustomerReports[]): FlattenedBatchCustomerRow[] => {
  return customers.map((customer) => ({
    ...
    shopOwnerDueAmt: customer.shopOwnerDueAmt,
...
const columns: GridColDef<FlattenedBatchCustomerRow>[] = React.useMemo(() => [
    ...
    {
      field: 'shopOwnerDueAmt',
      headerName: 'ShopOwner DueAmt',
      flex: 1,
      minWidth: 110,
      align: 'center',
      headerAlign: 'center',
  ...
  return (
    ...
    >
      <button
        ...
        className="absolute top-2.5 left-1.5 bg-blue-100 text-blue-600 hover:bg-blue-200 px-2 py-1 flex justify-center items-center rounded-sm border-[0.5px] border-blue-600 ease-in-out duration-300 text-sm z-50 hover:scale-101 cursor-pointer flex-row shadow-sm hover:shadow-md "
      >
        + New
      </button>
    </DataTable>
