...
export default function NewCustomer( props: {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        // If you need to upload the image file separately, use `selectedImageFile` here.
        // For example:
        // const formDataToSend = new FormData();
        // formDataToSend.append('name', formData.name);
        // formDataToSend.append('typeOfCustomer', formData.typeOfCustomer);
        // if (selectedImageFile) {
        //   formDataToSend.append('image', selectedImageFile);
        // }
        // await axios.post('/api/customers', formDataToSend);
        ...
        setSnackbarMessage(`Failed to add customer: ${err.message || "An unknown error occurred."}`);
  ...
  return (
    <section
      className='flex flex-col h-[600px] w-full sm:w-[800px] rounded-lg shadow-xl border border-gray-200 bg-white animate-slide-up relative overflow-hidden'
    >
      {/* Header */}
      <div className='flex items-center justify-between p-4 border-b border-gray-200 flex-shrink-0'>
        ...
        >
          <UserRound size={20} /> New Customer Entry
        </Typography>
        <button
