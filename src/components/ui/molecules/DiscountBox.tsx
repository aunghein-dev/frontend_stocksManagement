...
export default function DiscountBox() {
 ...
 const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div className="w-full border-[1px] border-gray-200 rounded-sm flex flex-col p-2 text-gray-700 justify-between">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-row items-center gap-2 justify-center text-center mt-1">
          <input
            ...
            className="w-full border-[1px] border-gray-200 rounded-sm px-3 py-2 text-sm"
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-600 text-white border-[0.5px] border-blue-600 text-sm py-2 px-2 rounded-sm transition-all duration-200 cursor-pointer font-semibold h-full whitespace-nowrap"
          >
