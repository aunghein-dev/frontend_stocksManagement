    ...
    >
      ...
      <div className="flex flex-row gap-2 overflow-x-auto custom-scrollbar min-h-[50px] pb-3">
        {suggestionAmounts.map((amount, index) => (
          <motion.button
            key={index}
            className="flex-shrink-0 bg-gray-50 px-4 py-2 rounded-sm text-md
      ...
      {/* Pay Now Button */}
      <motion.button
        className={`${loading? "bg-gray-300 ": "bg-blue-600 "}text-sm text-white rounded-sm py-3 px-4 w-full
